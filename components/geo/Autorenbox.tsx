  ...
  return (
    <div className="autorenbox">
      ...
      <p className="autorenbox-bio">
        Thomas Sander ist der Gruender von lackierer-stellenangebote.de. Mit jahrelanger Erfahrung im
        Bereich Lackierer und Personalwesen hat er dieses spezialisierte Jobportal
        ins Leben gerufen, um Arbeitgeber und qualifizierte Fachkraefte zusammenzubringen.
      </p>
      <div className="autorenbox-links">
        <a href="https://lackierer-stellenangebote.de/#/autor/thomas-sander">Mehr ueber den Autor</a>
        {' | '}
        <a href="https://de.linkedin.com/in/thomas-sander-520676303" target="_blank" rel="noopener noreferrer">LinkedIn</a>
      </div>
    </div>
  );
};
